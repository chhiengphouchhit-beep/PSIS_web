...
export default function AdminCMS({ onDatabaseUpdate }: AdminCMSProps) {
  ...
  const loadDatabase = () => {
    const loadedLeads = getPersistedLeads();
  ...
  // Status transitions
  const handleUpdateLeadStatus = (leadId: string, status: LeadStatus, notesText: string) => {
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {[
                  ...
                  { key: 'Contacted', label: 'Contacted', color: 'border-l-sky-500 hover:bg-sky-500/5', bgActive: 'bg-sky-500/10 border-sky-500/40 text-sky-450', icon: '✦' },
